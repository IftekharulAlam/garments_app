...
import 'package:garments_app/model/bill.dart';
        ...
        DataRow(cells: [
          ...
          DataCell(
            IconButton(
                ...
                onPressed: () {
                  setState(() {
                    int myProductRate = listOFProductRate.elementAt(i);
                    int myProductQuantity = listOFProductQuantity.elementAt(i);
